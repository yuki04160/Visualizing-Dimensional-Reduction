...
To visualize high-dimensional dataset (784 dimensions) in 2 dimensions, I implemented an unsupervised machine learning algorithm, t-SNE, in Python using GitHub dataset [fashion-minst](https://github.com/zalandoresearch/fashion-mnist), which is an image pixel dataset.
## Introduction
...
## Data Analysis
   ...
   - Visualize dimensional reduction
     ...
     - I used Pyplot in Matplotlib to visualize the dimension-reduced dataset.
       - In the plot, instead of using same color dots, I used the number (label) of the fashion product and different colors for different fashion products.
## Conclusion
